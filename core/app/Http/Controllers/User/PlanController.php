...
class PlanController extends Controller
{
    ...
    public function planStore(Request $request)
    {
        ...
        if ($plan->tree_com > 0) {
            ...
            // Tree Commission Logging (example - depends on your treeComission logic)
        ...
        // Referral Commission
        referralComission($user->id, $details); // Add similar logging inside referralComission() method

        // Level commissions with logging
