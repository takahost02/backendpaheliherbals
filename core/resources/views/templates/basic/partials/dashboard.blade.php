            ...
            <div class="col-lg-3">
                <div class="dashboard-sidebar">
                    ...
                    <ul class="user-dashboard-tab">
                        ...
                        <li>
                            <a href="{{ route('user.refferal.income') }}" class="{{menuActive('user.refferal.income')}}">
                                @lang('Refferal Income')
                            </a>
                        </li>
                         
                        <!--  <li>-->
                        <!--    <a href="{{ route('user.sponsor.income') }}" class="{{menuActive('user.sponsor.income')}}">-->
                        <!--        @lang('Sponsor Royalty Income')-->
                        <!--    </a>-->
                        <!--</li>-->
                          <li>
