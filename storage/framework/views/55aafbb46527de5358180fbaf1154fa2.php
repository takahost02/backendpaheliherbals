        ...
        <div class="card custom--card">
            ...
            <div class="card-body">
                <div class="alert alert-primary">
                    <p class="mb-0"><i class="las la-info-circle"></i> <?php echo app('translator')->get('You are requesting'); ?> <b><?php echo e(showAmount($withdraw->amount)); ?></b> <?php echo app('translator')->get('for withdraw.'); ?> <?php echo app('translator')->get('The admin will send you'); ?>
                        <b class="text--success"><?php echo e(showAmount($withdraw->final_amount,currencyFormat:false) .' '.$withdraw->currency); ?> </b> <?php echo app('translator')->get('to your account.'); ?></p>
                </div>
...
<?php echo $__env->make($activeTemplate.'layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/paheliherbals/backoffice.paheliherbals.com/core/resources/views/templates/basic/user/withdraw/preview.blade.php ENDPATH**/ ?>