<?php $__env->startSection('content'); ?>
    <div class="d-flex align-items-center justify-content-end mb-3 flex-wrap gap-3">
     ...
     <div class="header-left">
                                ...
                                <h6 class="ammount theme-two"><?php echo e(showAmount(auth()->user()->balance)); ?></h6>
                            </div>
   <!--  end-->
...
<?php echo $__env->make($activeTemplate . 'layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/paheliherbals/newplan.paheliherbals.com/core/resources/views/templates/basic/user/withdraw/log.blade.php ENDPATH**/ ?>