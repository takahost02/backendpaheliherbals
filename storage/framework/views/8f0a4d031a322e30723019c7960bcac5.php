...
<section class="blog-section padding-bottom pos-rel">
    ...
    <div class="col-lg-8 col-md-10">
        <div class="section-header text-center">
            <span class="subtitle" style="color: #ffffff;">
                <?php echo e(__(@$blogSectionContent->data_values->heading)); ?>

            </span>
            <h2 class="title" style="color: #ffffff;">
                <?php echo e(__(@$blogSectionContent->data_values->sub_heading)); ?>
...
<?php /**PATH /home/paheliherbals/newplan.paheliherbals.com/core/resources/views/templates/basic/sections/blog.blade.php ENDPATH**/ ?>