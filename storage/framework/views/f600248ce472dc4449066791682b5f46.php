...
<head>
    ...
    <title><?php echo e(gs()->siteName($pageTitle ?? '419 | Session has expired')); ?></title>
        ...
        <div class="container">
            <div class="row justify-content-center align-items-center">
                <div class="col-lg-7 text-center">
                    <img src="<?php echo e(asset('assets/errors/images/error-419.png')); ?>" alt="image">

                    <h2 class="title"> <?php echo app('translator')->get('Sorry! Your session has expired'); ?></h2>
                    <p class="description"><?php echo app('translator')->get('Please go back and refresh your browser and try again'); ?></p>
...
<?php /**PATH /home/paheliherbals/backoffice.paheliherbals.com/core/resources/views/errors/419.blade.php ENDPATH**/ ?>