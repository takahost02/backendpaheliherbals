                    ...
                    <div class="row justify-content-center gy-sm-4 gy-3">
                                ...
                                <?php $__currentLoopData = $gatewayCurrency; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <label for="<?php echo e(titleToKey($data->name)); ?>"
                                        ...
                                        <div class="payment-item__thumb">
                                            <img class="payment-item__thumb-img" src="<?php echo e(getImage(getFilePath('gateway') . '/' . $data->method->image)); ?>"
                                        ...
                                        <input class="payment-item__radio gateway-input" id="<?php echo e(titleToKey($data->name)); ?>" hidden
                                            data-gateway='<?php echo json_encode($data, 15, 512) ?>' type="radio" name="gateway" value="<?php echo e($data->method_code); ?>"
                                            ...
                                            data-min-amount="<?php echo e(showAmount($data->min_amount)); ?>" data-max-amount="<?php echo e(showAmount($data->max_amount)); ?>">
                                    </label>
                        ...
                        <div class="col-lg-6">
                            <div class="payment-system-list p-3">
                                ...
                                <div class="deposit-info">
                                    <div class="deposit-info__title">
                                        <p class="text has-icon"> <?php echo app('translator')->get('Limit'); ?>
                                            <span></span>
                                        </p>
                                    </div>
                                    <div class="deposit-info__input">
                                ...
                                <div class="deposit-info">
                                    <div class="deposit-info__title">
                                        <p class="text has-icon"><?php echo app('translator')->get('Processing Charge'); ?>
                                            <span data-bs-toggle="tooltip" title="<?php echo app('translator')->get('Processing charge for payment gateways'); ?>" class="proccessing-fee-info"><i
...
<?php echo $__env->make($activeTemplate . 'layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/paheliherbals/backend.paheliherbals.com/core/resources/views/templates/basic/user/payment/deposit.blade.php ENDPATH**/ ?>