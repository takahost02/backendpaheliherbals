...
<div class="col-12 mt-4">
    <div class="card shadow-sm border-0 p-4">
        ...
        <div class="row g-3">
            ...
            <div class="col-md-3 col-6">
                <div class="border rounded p-3 text-center">
                    <div class="small text-muted"><?php echo app('translator')->get('Binary Income'); ?></div>
            ...
            <div class="col-md-3 col-6">
                <div class="border rounded p-3 text-center">
                    <div class="small text-muted"><?php echo app('translator')->get('Direct Referral'); ?></div>
            ...
            <div class="col-md-3 col-6">
                <div class="border rounded p-3 text-center">
                    <div class="small text-muted"><?php echo app('translator')->get('Matching Bonus'); ?></div>
        ...
        <div class="text-end small text-muted">
            <?php echo app('translator')->get('Updated on'); ?>: <?php echo e(now()->format('d M Y, h:i A')); ?>
...
<?php echo $__env->make($activeTemplate.'layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/paheliherbals/test2.paheliherbals.com/core/resources/views/templates/basic/user/binarySummery.blade.php ENDPATH**/ ?>