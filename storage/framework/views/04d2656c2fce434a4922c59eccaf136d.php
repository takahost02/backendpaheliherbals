...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.image-uploader','data' => ['image' => ''.e($method->image).'','class' => 'w-100','type' => 'withdrawMethod','required' => false]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['image' => ''.e($method->image).'','class' => 'w-100','type' => 'withdrawMethod','required' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false)]); ?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-text">1 <?php echo e(__(gs('cur_text'))); ?>

                                                        =
                                                    </span>
                                                    <input type="number" step="any" class="form-control rateInput" name="rate" value="<?php echo e(getAmount($method->rate)); ?>" required/>
                                        ...
                                        <div class="card border--primary mb-2">
                                            ...
                                            <div class="card-body">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" class="form-control minLimit" name="min_limit" value="<?php echo e(getAmount($method->min_limit)); ?>" required/>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/paheliherbals/public_html/core/resources/views/admin/withdraw/edit.blade.php ENDPATH**/ ?>