        ...
        <div class="table-responsive--sm">
            <table class="table custom--table">
                ...
                <tr>
                    ...
                    <th><?php echo app('translator')->get('Binary Comm'); ?></th>
                </tr>
                </thead>
                <tbody>
                <tr>
                    ...
                    <td><?php echo e(getAmount($binaryCommission)); ?></td>
                </tr>
                </tbody>
            </table>
        </div>
...
<?php echo $__env->make($activeTemplate.'layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/paheliherbals/backoffice.paheliherbals.com/core/resources/views/templates/basic/user/binarySummery.blade.php ENDPATH**/ ?>