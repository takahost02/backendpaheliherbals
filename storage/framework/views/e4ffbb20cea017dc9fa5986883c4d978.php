            ...
            <div class="col-lg-3">
                <div class="dashboard-sidebar">
                    ...
                    <ul class="user-dashboard-tab">
                        ...
                        <li>
                            <a href="<?php echo e(route('user.royalty.summery')); ?>" class="<?php echo e(menuActive('user.royalty.summery')); ?>">
                                <?php echo app('translator')->get('Royalty Summery'); ?>
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('user.binary.summery')); ?>" class="<?php echo e(menuActive('user.binary.summery')); ?>">
                                <?php echo app('translator')->get('Binary Summery'); ?>
                            </a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="<?php echo e(route('user.refferal.income')); ?>" class="<?php echo e(menuActive('user.refferal.income')); ?>">
                                <?php echo app('translator')->get('Refferal Income'); ?>
                            </a>
                        </li>
                          <li>
...
</section><?php /**PATH /home/paheliherbals/backoffice.paheliherbals.com/core/resources/views/templates/basic/partials/dashboard.blade.php ENDPATH**/ ?>