...
/*Route::get('/kyc', [\App\Http\Controllers\Admin\KycAdminController::class, 'index']);
Route::post('/kyc/{id}/approve', [\App\Http\Controllers\Admin\KycAdminController::class, 'approve']);
Route::post('/kyc/{id}/reject', [\App\Http\Controllers\Admin\KycAdminController::class, 'reject']);*/

Route::prefix('kyc')->group(function () {
    Route::get('/pending', [KycAdminController::class, 'pending'])->name('admin.kyc.pending');
    Route::get('/{id}', [KycAdminController::class, 'show'])->name('admin.kyc.show');
    Route::post('/{id}/approve', [KycAdminController::class, 'approve'])->name('admin.kyc.approve');
    Route::post('/{id}/reject', [KycAdminController::class, 'reject'])->name('admin.kyc.reject');
});

Route::get('admin/matrix', [MatrixController::class,'index'])
    ->name('admin.matrix.index');


Route::get('reward-income', [RewardController::class,'index'])
    ->name('admin.reward.index');

Route::get('reward-pay/{id}', [RewardController::class,'pay'])
    ->name('admin.reward.pay');
...
Route::namespace('Auth')->group(function () {
    Route::middleware('admin.guest')->group(function () {
        ...
        Route::get('matrix-report', [MatrixController::class,'index'])
    ->name('admin.matrix.report');

Route::get('matrix-rollback/{id}', [MatrixController::class,'rollback'])
    ->name('admin.matrix.rollback');
...
Route::middleware('admin')->group(function () {
    ...
    */
    Route::prefix('withdraw')->name('withdraw.')->group(function () {
        ...
        Route::controller(WithdrawalController::class)
            ...
            ->group(function () {
                ...
                // Lists
                Route::get('pending/{user?}', 'pending')->name('pending');
                Route::get('approved/{user?}', 'approved')->name('approved');
                Route::get('rejected/{user?}', 'rejected')->name('rejected');
                Route::get('all/{user?}', 'all')->name('all');

                // Details
                Route::get('details/{withdraw}', 'details')->name('details');

                // Actions
                Route::post('approve/{withdraw}', 'approve')->name('approve');
                Route::post('reject/{withdraw}', 'reject')->name('reject');
            });
        ...
        */
        Route::controller(WithdrawMethodController::class)
            ...
            ->group(function () {
                ...
                Route::put('edit/{method}', 'update')->name('update');

                Route::patch('status/{method}', 'status')->name('status');
            });
    });
    ...
    Route::controller('ReportController')->prefix('report')->name('report.')->group(function () {
        ...
        Route::get('myupline/{user_id}', 'myupline')->name('myupline');
    });
    ...
    //report
    Route::get('binary/report', 'BinaryController@report')
