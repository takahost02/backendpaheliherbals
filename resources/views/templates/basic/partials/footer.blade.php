        ...
        <div class="container">
            <div class="footer-bottom-wrapper">
               <!--<p class="copy-text">&copy; @lang('All Right Reserved By') <a href="{{ route('home') }}">{{ __(gs('site_name')) }}</a></p>-->
                <p class="copy-text">Copyrigh &copy; <script type="text/javascript">document.write(new Date().getFullYear());</script>, Paheli Herbal's Marketing, @lang('All Right Reserved , Developed by ') <a href="https://takahostwebsolution.com">Takahost Web Solution</a></a></p>
