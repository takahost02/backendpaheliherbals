    ...
    <div class="row">
        <div class="col-12">
            <div class="row gy-4">
                ...
                <div class="col-xxl-3 col-sm-6">
                    <x-widget type="2" value="{{ showAmount($user->total_binary_com) }}" title="Total Binary Commission" style="7" link="{{ route('admin.report.binary.commission', $user->id) }}" icon="la la-tree" bg="2" />
                </div>
                <div class="col-xxl-3 col-sm-6">
                    <x-widget type="2" value="{{ showAmount($user->total_level_com) }}" title="Total Level Commission" style="7" link="{{ route('admin.report.binary.commission', $user->id) }}" icon="la la-tree" bg="2" />
                </div>
                <div class="col-xxl-3 col-sm-6">
                    <x-widget type="2" value="{{ showAmount($user->total_repurchase_com) }}" title="Total Repurchase Commission" style="7" link="{{ route('admin.report.binary.commission', $user->id) }}" icon="la la-tree" bg="2" />
                </div>
                <div class="col-xxl-3 col-sm-6">
                    <x-widget type="2" value="{{ showAmount($user->total_royalty_com) }}" title="Total Royalty Commission" style="7" link="{{ route('admin.report.binary.commission', $user->id) }}" icon="la la-tree" bg="2" />
                </div>
                ...
                <div class="col-xxl-3 col-sm-6">
                    <x-widget type="2" value="{{ $totalMyUpline }}" title="Total Upline" 
                        style="7" 
                        link="{{ route('admin.report.myupline', $user->id) }}" icon="las la-users" 
                        bg="16" />
                </div>
