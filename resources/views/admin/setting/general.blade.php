                ...
                <form action="{{ route('admin.users.matching-bonus.update') }}" method="post">
                    <div class="card-body">
                        ...
                        <div class="row justify-content-between">
                            ...
                            <div class="col-md-4 form-group">
                                <div class="input-group">
                                    <input class="form-control" id="royalty_bonus_percentage" name="royalty_bonus_percentage" type="number" step="0.01" value="{{ getAmount(gs('royalty_bonus_percentage')) }}" 
                                        aria-describedby="royalty_bonus" required>
                                    <span class="input-group-text" id="royalty_bonus">@lang('Royalty %')</span>
                                </div>
                            </div>
                        </div>
                        <div class="row">
